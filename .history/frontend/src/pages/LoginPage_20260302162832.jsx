        ...
        <div className={styles.left}>
          <div className={styles.leftInner}>
            ...
            <div className={styles.features}>
              {['Real-time order tracking', 'Secure SmartCard wallet', 'Ramadan advance booking'].map((f, i) => (
                <div key={i} className={styles.feature} style={{ animationDelay: `${0.3 + i * 0.1}s` }}>
        ...
        <div className={styles.right}>
          ...
          <div className={styles.toggleWrap}>
            ...
            <button 
              ...
              onClick={() => { setUserType('admin'); setError(''); setEmail(''); setPassword('') }}
              type="button"
            >
              Admin
            </button>
          ...
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <div>
                <h2 className={styles.cardTitle}>{userType === 'student' ? 'Welcome back' : 'Admin Portal'}</h2>
                <p className={styles.cardSub}>{userType === 'student' ? 'Sign in to My IUT' : 'Mission Control Access'}</p>
              </div>
            </div>

            <form onSubmit={handleSubmit} className={styles.form}>
              <div className={styles.field}>
                <label className={styles.label}>{userType === 'student' ? 'Student Email' : 'Username'}</label>
                <div className={styles.inputWrap}>
                  ...
                  <input
                    ...
                    type="text"
                    placeholder={userType === 'student' ? '230042135@iut-dhaka.edu' : 'admin username'}
                    value={email}
