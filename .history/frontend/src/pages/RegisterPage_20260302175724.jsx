...
export default function RegisterPage() {
  ...
  const pwRules = [
    ...
    { test: /[a-zA-Z]/.test(form.password), label: 'Contains a letter' },
    { test: /[0-9]/.test(form.password), label: 'Contains a digit' },
    { test: /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?`~]/.test(form.password), label: 'Contains a special character' },
  ]
