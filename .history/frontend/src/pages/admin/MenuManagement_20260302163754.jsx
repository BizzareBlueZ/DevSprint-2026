...
export default function MenuManagement() {
    ...
    const [formData, setFormData] = useState({
        name: '', description: '', price: '', category: 'main', is_available: true, initial_stock: 50
    })
    ...
    function openNew() {
        setEditItem(null)
        setFormData({ name: '', description: '', price: '', category: 'main', is_available: true, initial_stock: 50 })
        setShowModal(true)
    }
    ...
    return (
        <div className={styles.page}>
            <div className={styles.header}>
                ...
                <button className={styles.addBtn} onClick={openNew}>+ Add Item</button>
            </div>
                    ...
                    <div className={styles.modal} onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className={styles.modalActions}>
                                ...
                                <button type="submit" className={styles.submitBtn}>{editItem ? 'Update' : 'Create'}</button>
                            </div>
                        </form>
                    </div>
                </div>
