    ...
    return (
        <div className={styles.page}>
            <div className={styles.header}>
                ...
                <button className={styles.refreshBtn} onClick={fetchAnalytics}>↻ Refresh</button>
            </div>
            ...
            <div className={styles.statsGrid}>
                ...
                <div className={styles.statCard}>
                    <div className={styles.statIcon}>💰</div>
                    <div className={styles.statValue}>৳{parseFloat(totals?.total_revenue || 0).toFixed(0)}</div>
                        ...
                        {popularItems?.map((item, i) => (
                            <div key={item.id} className={styles.listItem}>
                                ...
                                <div className={styles.listItemStats}>
                                    ...
                                    <span className={styles.revenue}>৳{parseFloat(item.total_revenue || 0).toFixed(0)}</span>
                                </div>
                            </div>
                        ))}
                        ...
                        <table className={styles.table}>
                            ...
                            <tbody>
                                ...
                                {(!dailyRevenue || dailyRevenue.length === 0) && (
                                    <tr><td colSpan="3" className={styles.empty}>No revenue data yet</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
