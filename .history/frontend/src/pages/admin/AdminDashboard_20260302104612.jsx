...
const SERVICES = [
    { id: 'identity-provider', name: 'Identity Provider', port: 3001, icon: '🔐', desc: 'JWT Auth', category: 'auth' },
    { id: 'order-gateway',     name: 'Order Gateway',     port: 3000, icon: '🚪', desc: 'API Gateway', category: 'gateway' },
    { id: 'stock-service',     name: 'Stock Service',     port: 3002, icon: '📦', desc: 'Inventory', category: 'data' },
    { id: 'kitchen-queue',     name: 'Kitchen Queue',     port: 3003, icon: '🍳', desc: 'Async Orders', category: 'processing' },
    { id: 'notification-hub',  name: 'Notification Hub',  port: 3004, icon: '🔔', desc: 'Real-time', category: 'realtime' },
]
