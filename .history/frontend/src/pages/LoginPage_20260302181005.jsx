        ...
        <div className={styles.right}>
          ...
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <div>
                <h2 className={styles.cardTitle}>{userType === 'student' ? t('welcomeBack') : 'Admin Portal'}</h2>
                <p className={styles.cardSub}>{userType === 'student' ? t('signIn') : 'Mission Control Access'}</p>
              </div>
            </div>
