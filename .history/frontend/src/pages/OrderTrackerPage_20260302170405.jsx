...
const STEPS = [
  ...
  { key: 'STOCK_VERIFIED', label: 'Stock Verified',   desc: 'Ingredients confirmed in stock',    icon: '✅' },
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        ...
        {orderInfo?.itemName && (
          <p className={styles.itemName}>{orderInfo.itemName}</p>
        )}
        <div className={`${styles.liveBadge} ${connected ? styles.liveBadgeOn : styles.liveBadgeOff}`}>
          ...
          {STEPS.map((step, i) => {
            ...
            return (
              ...
              >
                {/* Connector line */}
                {i > 0 && (
                  <div className={`${styles.connector} ${i <= currentIdx ? styles.connectorFilled : ''}`} />
                )}
