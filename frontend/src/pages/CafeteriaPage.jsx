      ...
      {orderModal && (
        ...
        >
          <div className={styles.modal} onClick={e => e.stopPropagation()}>
            ...
            <p className={styles.modalDesc}>{t('menu')}:</p>
              ...
              {menu.map(item => (
                ...
                >
                  <div className={styles.menuItemInfo}>
                    ...
                    {item.avg_rating > 0 && (
                      <span className={styles.menuItemRating}>
                ...
                <div className={styles.timeSlots}>
                  ...
                  <div className={styles.timeSlotsGrid}>
                    {timeSlots.slice(0, 8).map(slot => (
                      <button
                        key={slot.time}
                        className={`${styles.timeSlot} ${selectedTimeSlot?.time === slot.time ? styles.timeSlotSelected : ''}`}
            ...
            <div className={styles.modalActions}>
              ...
              <button
                ...
                disabled={orderLoading || !selectedItem || (showSchedule && !selectedTimeSlot)}
              >
                {orderLoading ? <span className="spinner" /> : t('confirm')}
              </button>
            </div>
          </div>
        </div>
