...
function createPool(options = {}, logger = console) {
  ...
  pool.on('connect', (client) => {
    logger.debug({ totalCount: pool.totalCount, idleCount: pool.idleCount }, 'New database connection')
  ...
  pool.on('acquire', () => {
    logger.debug({ totalCount: pool.totalCount, idleCount: pool.idleCount, waitingCount: pool.waitingCount }, 'Connection acquired')
  })
